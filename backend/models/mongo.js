...
async function init() {
    try {
        ...
        await mongoose.connect('mongodb+srv://neeru:neeru@cluster0-6qdoa.mongodb.net/Search?retryWrites=true&w=majority', { useNewUrlParser: true, useUnifiedTopology: true, useCreateIndex: true });
